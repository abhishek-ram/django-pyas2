...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pyas2.PublicCertificate'),
        ),
        migrations.AddField(
            model_name='partner',
            name='signature_cert',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partner_s', to='pyas2.PublicCertificate'),
        ),
        migrations.AddField(
            model_name='organization',
            name='encryption_key',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pyas2.PrivateKey'),
        ),
        migrations.AddField(
            model_name='organization',
            name='signature_key',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_s', to='pyas2.PrivateKey'),
        ),
        migrations.AddField(
            model_name='message',
            name='organization',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pyas2.Organization'),
        ),
        migrations.AddField(
            model_name='message',
            name='partner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pyas2.Partner'),
        ),
        migrations.AddField(
            model_name='mdn',
            name='message',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='pyas2.Message'),
        ),
        migrations.AlterUniqueTogether(
            name='message',
            unique_together=set([('message_id', 'partner')]),
        ),
    ]
